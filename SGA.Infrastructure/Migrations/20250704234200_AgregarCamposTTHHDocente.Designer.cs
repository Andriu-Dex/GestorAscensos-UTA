...
namespace SGA.Infrastructure.Migrations
{
    ...
    [Migration("20250704234200_AgregarCamposTTHHDocente")]
    partial class AgregarCamposTTHHDocente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SGA.Domain.Entities.Docente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 4, 23, 42, 0, 108, DateTimeKind.Utc).AddTicks(7979),
                            FechaInicioNivelActual = new DateTime(2020, 7, 4, 23, 42, 0, 108, DateTimeKind.Utc).AddTicks(7615),
                        ...
                        new
                        {
                            ...
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 4, 23, 42, 0, 108, DateTimeKind.Utc).AddTicks(7989),
                            FechaInicioNivelActual = new DateTime(2023, 7, 4, 23, 42, 0, 108, DateTimeKind.Utc).AddTicks(7987),
            ...
            modelBuilder.Entity("SGA.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@uta.edu.ec",
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 4, 23, 41, 59, 909, DateTimeKind.Utc).AddTicks(388),
                            IntentosLogin = 0,
                            PasswordHash = "$2a$11$tduzNjNAPD1.2zhVZmhrW.VVp0AwU1OOYb656hMVDw/CQznsFJkt.",
                            Rol = "Administrador",
                            UltimoLogin = new DateTime(2020, 7, 4, 23, 41, 59, 909, DateTimeKind.Utc).AddTicks(75)
                        },
                        new
                        {
                            ...
                            Email = "sparedes@uta.edu.ec",
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 4, 23, 42, 0, 107, DateTimeKind.Utc).AddTicks(9774),
                            IntentosLogin = 0,
                            PasswordHash = "$2a$11$jQFJKDVDtyEcJvqysVgsyOTDx7nPhFy.flhWhT2WximYhrYCtTH/K",
                            Rol = "Docente",
                            UltimoLogin = new DateTime(2025, 6, 4, 23, 42, 0, 107, DateTimeKind.Utc).AddTicks(9650)
                        });
                });
