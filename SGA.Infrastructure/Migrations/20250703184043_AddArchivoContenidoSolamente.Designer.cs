...
namespace SGA.Infrastructure.Migrations
{
    ...
    [Migration("20250703184043_AddArchivoContenidoSolamente")]
    partial class AddArchivoContenidoSolamente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SGA.Domain.Entities.Docente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 3, 18, 40, 42, 850, DateTimeKind.Utc).AddTicks(9354),
                            FechaInicioNivelActual = new DateTime(2020, 7, 3, 18, 40, 42, 850, DateTimeKind.Utc).AddTicks(8746),
                        ...
                        new
                        {
                            ...
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 3, 18, 40, 42, 850, DateTimeKind.Utc).AddTicks(9368),
                            FechaInicioNivelActual = new DateTime(2023, 7, 3, 18, 40, 42, 850, DateTimeKind.Utc).AddTicks(9365),
            ...
            modelBuilder.Entity("SGA.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@uta.edu.ec",
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 3, 18, 40, 42, 666, DateTimeKind.Utc).AddTicks(1743),
                            IntentosLogin = 0,
                            PasswordHash = "$2a$11$la1YZaVLKcoRQOpjlRP.XuPunKYgKgBRMAs4YcmaPXv/TXrtvpASy",
                            Rol = "Administrador",
                            UltimoLogin = new DateTime(2020, 7, 3, 18, 40, 42, 666, DateTimeKind.Utc).AddTicks(1510)
                        },
                        new
                        {
                            ...
                            Email = "sparedes@uta.edu.ec",
                            EstaActivo = true,
                            FechaCreacion = new DateTime(2025, 7, 3, 18, 40, 42, 850, DateTimeKind.Utc).AddTicks(395),
                            IntentosLogin = 0,
                            PasswordHash = "$2a$11$kG2G3sDLcEDpuQQYUqnITuLwAEda3.RZlLmbxd.1YRnvwvTOShbgu",
                            Rol = "Docente",
                            UltimoLogin = new DateTime(2025, 6, 3, 18, 40, 42, 850, DateTimeKind.Utc).AddTicks(259)
                        });
                });
