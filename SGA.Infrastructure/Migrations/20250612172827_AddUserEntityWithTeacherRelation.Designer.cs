...
namespace SGA.Infrastructure.Migrations
{
    ...
    [Migration("20250612172827_AddUserEntityWithTeacherRelation")]
    partial class AddUserEntityWithTeacherRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SGA.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$N8qvJ3F5k2lQ8vJ9x5G2H.QJKzF3FJGTj8K5vQ3F2h7Bx8vN3F5k2",
                            UserTypeId = 1,
                            Username = "admin"
                        });
                });
