...
namespace SGA.Application.DTOs
{
    ...
    public class CreateTipoDocumentoDto
    {
        ...
        /// </summary>
        public bool ValidacionRequerida { get; set; } = false;
        ...
        /// Indica si el tipo de documento debe estar activo al momento de la creación (por defecto true)
        /// </summary>
        public bool Activo { get; set; } = true;

        /// <summary>
        /// Indica si el tipo de documento debe estar activo (nueva propiedad)
        /// </summary>
